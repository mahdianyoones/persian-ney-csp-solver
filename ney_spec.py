...
spec = {
	...
	"h2":			round(428.4),				# 2nd hole from top
	"h3":			round(392.9),				# 3rd hole from top
	"h4":			round(370.8),				# 4th hole from top
	"h5":			round(350.0),				# 5th hole from top
	"h6":			round(311.8),				# 6th hole from top
